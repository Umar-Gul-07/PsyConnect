    ...
    return (
        <>
            ...
            <div className="site-main">
                ...
                {/*broken-section end*/}
                {/*connect-section_3*/}
                <section className="ttm-row connect-section_3 bg-img3 mt_95 res-991-mt-0 ttm-textcolor-white clearfix">
                    <div className="container">
                        {/*row*/}
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <div className="row-title style1">
                                    {/* section title */}
                                    <div className="section-title without-seperator text-center">
                                        <div className="title-header">
                                            <h2 className="title">
                                                A step away from <strong>Improving</strong>
                                                <br />
                                    ...
                                    {/* section title end */}
                                    <div className="row ttm-vertical_sep pt-15">
                                        <div className="col-sm-12 offset-md-1 col-md-5 col-lg-3 offset-lg-3">
                                            {/*featured-icon-box*/}
                                            <div className="featured-icon-box icon-align-before-content ttm-textcolor-white style7 float-md-right pr-30 res-991-pr-0">
                                                <div className="featured-content text-right pl-0 pr-20">
                                                ...
                                                <div className="featured-icon">
                                                    <div className="ttm-icon ttm-icon_element-onlytxt ttm-icon_element-color-white ttm-icon_element-style-rounded ttm-icon_element-size-sm">
                                        ...
                                        <div className="col-sm-12 col-md-5 col-lg-3">
                                            {/*featured-icon-box*/}
                                            <div className="featured-icon-box icon-align-before-content ttm-textcolor-white style7">
                                                <div className="featured-icon">
                                                    <div className="ttm-icon ttm-icon_element-onlytxt ttm-icon_element-color-white ttm-icon_element-style-rounded ttm-icon_element-size-sm">
                                                        <i className="flaticon flaticon-email" />
                                                    </div>
                                                </div>
                                    ...
                                    <a
                                        className="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-white mt-40 res-991-mt-20"
                                        href="contact.html"
                                    >
                                        Get Started Now!
                                    </a>
